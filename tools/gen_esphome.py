...
def main() -> int:
    ...
    # The sfx implementation moved to gen_esphome_audio.py (the 500-line cap;
    # the seam is honest — nothing about cues, everything about which bytes
    # play and from where).
    ...
    print(
        ...
        f"{LIGHTS_OUT.name} + {LIGHTS_S3_OUT.name}"
    )
